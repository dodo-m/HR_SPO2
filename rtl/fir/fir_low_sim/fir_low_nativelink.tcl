...
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.fir_low_tb -section_id tb
...
if {[file exists fir_low_coef_reload.txt]} {
  set_global_assignment -name EDA_TEST_BENCH_FILE fir_low_coef_reload.txt -section_id tb -library work
}
if {[file exists fir_low_coef_reload_rtl.txt]} {
  set_global_assignment -name EDA_TEST_BENCH_FILE fir_low_coef_reload_rtl.txt -section_id tb -library work
}
set_global_assignment -name EDA_TEST_BENCH_FILE fir_low_input.txt -section_id tb -library work

set_global_assignment -name EDA_TEST_BENCH_FILE fir_low_tb.vhd -section_id tb -library work
