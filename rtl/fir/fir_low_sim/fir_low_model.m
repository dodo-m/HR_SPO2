...
% Generated on: 11/13/2021 15:03:46
...
for j = 1:sx
    ...
    for i = 1: num_ch
     ...
     % run this output through the model 
      if(bankcount>1)
        output = fir_low_mlab(data_channel, bank_channel);
      else
        output = fir_low_mlab(data_channel);
      end
    ...
    file_name = ['fir_low_model_output'];
