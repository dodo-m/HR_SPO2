...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "D:/altera/set_up/quartus/"
} 
...
alias com {
  ...
  vcom "$QSYS_SIMDIR/fir_low_rtl.vhd"                                
  vcom "$QSYS_SIMDIR/fir_low_ast.vhd"                                
  vcom "$QSYS_SIMDIR/fir_low.vhd"                                    
  vcom "$QSYS_SIMDIR/fir_low_tb.vhd"                                 
}
...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
